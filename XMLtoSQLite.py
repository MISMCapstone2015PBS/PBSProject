...
def xml_to_df(file_path, xml_file):
    ...
    # Get exhaustive list of all tags/attributes in each block
    ...
    # Add each dictionary as a row in Pandas Dataframe/ Table structure
